...
function Ramp(input){
    ...
    if (typeof input === 'object'){
        ...
        let preset = input === 'fire' ? [[44,44,46,255],[103,48,43,255],[199,75,51,255],[249,157,80,255],[247,246,163,255]] : input === 'sunshine' ? [[89,14,34,255],[12,3,68,255],[52,137,218,255],[255,255,255,255],[255,210,47,255],[174,67,13,255]] : input === 'inferno' ? [[0,0,0,255],[58,15,110,255],[140,40,129,255],[221,73,104,255],[253,158,108,255],[251,251,190,255]] : input === 'gothic' ? [[255,255,255,255],[252,237,177,255],[154,75,89,255],[32,42,66,255],[0,0,0,255]] : input === 'radio' ? [[18,20,22],[32,64,96],[252,248,126]] : [[0,0,0],[255,255,255]];
        for (let i = 0; i < preset.length; i++){
            this.colors.push(new Color(preset[i], this, i));
        }
    }
}
...
function light(){
    if (arguments.length == 1){
        ...
        let ramp, domain, interpolation, result, mode;
        ...
        return function(value){
            return lightMap((value - domain[0]) / (domain[1] - domain[0]), ramp, false, interpolation, mode).rgbString;
        }
        //return lightMap(fraction, ramp, false, interpolation, mode).rgbString;
    }
}
